                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Visibility(
                              visible: ConstRes.aUserId == userData?.id
                                  ? false
                                  : true,
                              child: InkWell(
                        ...
                        Visibility(
                          visible:
                              ConstRes.aUserId == userData?.id ? false : true,
                          child: InkWell(
                            onTap: onChatWithTap,
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: Text(
                                  '${AppRes.chatWithNatalia}${userData?.fullname?.toUpperCase()}',
                                  style: const TextStyle(
                                    color: ColorRes.red3,
                                    fontSize: 12,
                                    fontFamily: FontRes.bold,
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Text(
                                '${AppRes.share} ${userData?.fullname?.toUpperCase()}\'S ${AppRes.profileCap}',
                                style: const TextStyle(
                                  color: ColorRes.white,
                                  fontSize: 12,
                                  fontFamily: FontRes.bold,
                        ...
                        Visibility(
                          ...
                          child: Center(
                            child: InkWell(
                              onTap: onReportTap,
                              child: Text(
                                '${AppRes.reportNatalia}${userData?.fullname?.toUpperCase()}',
                                style: TextStyle(
