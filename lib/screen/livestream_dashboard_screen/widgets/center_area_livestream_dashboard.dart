                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            LinearProgressIndicator(
                              ...
                              value: ConstRes.minThreshold == 0
                                  ? 0
                                  : coinValue / ConstRes.minThreshold,
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  '${AppRes.threshold}${ConstRes.minThreshold}',
                                  style: const TextStyle(
                                    fontSize: 13,
                                    color: ColorRes.lightGrey4,
                                  ),
                            ...
                            Row(
                              ...
                              children: [
                                InkWell(
                                  onTap: coinValue >= ConstRes.minThreshold
                                      ? onRedeemTap
                                      : () {
                                          Get.snackbar('SOORY',
                                              'You are not a REDEM user !',
                                              snackPosition:
