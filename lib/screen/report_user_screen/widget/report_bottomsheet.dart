...
import 'package:helnay/screen/report_user_screen/widget/report_reason_drop_down_box.dart';
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: explainMoreError != ""
                            ? Border.all(color: ColorRes.red9)
                            : Border.all(color: ColorRes.transparent)),
                    child: TextField(
