...
import 'package:helnay/screen/livestream_dashboard_screen/livestream_dashboard_screen.dart';
import 'package:helnay/screen/login_dashboard_screen/login_dashboard_screen.dart';
import 'package:helnay/screen/notes_screen/note_home_screen.dart';
import 'package:helnay/screen/verification_screen/verification_screen.dart';
...
class OptionalScreenViewModel extends BaseViewModel {
  ...
  void goToNotes() {
    Get.to(
      () => HomePageNoteApp(),
      arguments: {"id": userData?.id, "fullname": userData?.fullname},
    );
  }
